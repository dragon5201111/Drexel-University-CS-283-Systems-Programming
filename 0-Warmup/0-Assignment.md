...
3. Please provide a link to the repository you are using for this class.
    ...
    [Link to the coursework repo](https://github.com/dragon5201111/Drexel-University-CS-283-Systems-Programming)

4. Briefly describe what you want to get out of this class.

    **From this class, I want to further develop my understanding of the operating system and the C programming language; I would like to absolve some of the abstractions surrounding how a computer operates at a lower level.**

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    **I believe in myself for being successful in this class and know I will do well as long as I put in the time and effort to do so.**